...
int main(int argc, char **argv)
{
    if(argc != 8)
    {
        cerr << endl << "Usage: ./mono_tum path_to_vocabulary path_to_settings path_to_image_folder path_to_times_file path_to_imu_data path_to_output_folder skip_frames" << endl;
        return 1;
    }

	string strOutputPath = string(argv[6]);
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        cout << "IMU time: " << setprecision(20) << tempIMU << endl;
        cout << "Frame time: " << setprecision(20) << tempFrame << endl;
        cout << "Time diff: " << setprecision(20) << tempFrame - tempIMU << endl;
        //cout << ((tframe - vIMUPositions[nIMUc].timestamp) >= 0) << endl; 
        //while((tframe - vIMUPositions[nIMUc].timestamp) >= 0)
        */
        while(tempIMU < tempFrame)
        {
        	//cout << nIMUc << " IMU time: "<< setprecision(20) << tempIMU << endl;
        	//cout << nIMUc << " Frame time: " << setprecision(20) <<  tempFrame << endl;
